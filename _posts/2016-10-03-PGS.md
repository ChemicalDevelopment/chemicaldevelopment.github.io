...
It uses the file we created above to verify whether each number is prime, by checking the <1>
    <an></an>
    <2></2>
    <bn></bn>
    <!--  -->
</1>$th bit of the list of `1`s and `0`s
...
If it fits our criteria, we log it.
